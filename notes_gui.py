...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.noteTextEdit.setGeometry(QtCore.QRect(10, 10, 641, 561))
        self.noteTextEdit.setObjectName("noteTextEdit")
        self.tagTextEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.tagTextEdit.setGeometry(QtCore.QRect(660, 350, 201, 31))
        self.tagTextEdit.setObjectName("tagTextEdit")
        self.addTagButton = QtWidgets.QPushButton(self.centralwidget)
        self.addTagButton.setGeometry(QtCore.QRect(660, 390, 99, 27))
        ...
        self.removeTagButton.setGeometry(QtCore.QRect(760, 390, 99, 27))
        self.removeTagButton.setObjectName("removeTagButton")
        self.tagsListView = QtWidgets.QListView(self.centralwidget)
        self.tagsListView.setGeometry(QtCore.QRect(660, 490, 201, 81))
        ...
        self.searchTagButton.setGeometry(QtCore.QRect(660, 420, 201, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tagTextEdit.setPlaceholderText(_translate("MainWindow", "Введите тег..."))
